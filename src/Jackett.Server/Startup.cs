...
namespace Jackett.Server
{
 ...
 new DefaultContractResolver());
            ...
            services.AddDataProtection().PersistKeysToFileSystem(dataProtectionFolder).SetApplicationName("Jackett");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IHostApplicationLifetime applicationLifetime)
        {
            ...
            var rewriteOptions = new RewriteOptions()
                                 .AddRewrite(
                                     @"^torznab\/([\w-]*)", "api/v2.0/indexers/$1/results/torznab",
                                     true) //legacy torznab route
                                 .AddRewrite(
                                     @"^potato\/([\w-]*)", "api/v2.0/indexers/$1/results/potato", true) //legacy potato route
                                 .Add(RedirectRules.RedirectToDashboard);
            app.UseRewriter(rewriteOptions);
            app.UseStaticFiles();
            app.UseAuthentication();
