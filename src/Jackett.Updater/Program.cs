    ...
    public class Program
    {
        ...
        private void ProcessUpdate(UpdaterConsoleOptions options)
        {
            ...
            var oldFiles = new string[] {
                ...
                "Indexers/Andraste.json",
                "Indexers/Andraste.json.bak",
                "Indexers/aox.json",
                ...
                "Indexers/BestFriends.json",
                "Indexers/BestFriends.json.bak",
                "Indexers/bithq.json",
                "Indexers/bithq.json.bak",
                "Indexers/bitme.json",
                "Indexers/bitme.json.bak",
                "Indexers/BitMeTV.json",
                "Indexers/BitMeTV.json.bak",
                "Indexers/BitsPiracy.json",
                "Indexers/BitsPiracy.json.bak",
                ...
                "Indexers/corsarored.json",
                "Indexers/corsarored.json.bak",
                ...
                "Indexers/danishbits.json",
                "Indexers/danishbits.json.bak",
                "Indexers/demonsite.json",
                "Indexers/demonsite.json.bak",
                "Indexers/digbt.json",
                "Indexers/digbt.json.bak",
                "Indexers/digitalhive.json",
                "Indexers/digitalhive.json.bak",
                ...
                "Indexers/FrenchAdn.json",
                "Indexers/FrenchAdn.json.bak",
                "Indexers/FrenchTorrentDb.json",
                "Indexers/FrenchTorrentDb.json.bak",
                "Indexers/Freshon.json",
                "Indexers/Freshon.json.bak",
                "Indexers/gdf76.json",
                "Indexers/gdf76.json.bak",
                "Indexers/GFTracker.json",
                "Indexers/GFTracker.json.bak",
                "Indexers/gfxnews.json",
                "Indexers/gfxnews.json.bak",
                "Indexers/GhostCity.json",
                "Indexers/GhostCity.json.bak",
                "Indexers/gods.json",
                ...
                "Indexers/Hardbay.json",
                "Indexers/Hardbay.json.bak",
                ...
                "Indexers/HouseOfTorrents.json",
                "Indexers/HouseOfTorrents.json.bak",
                ...
                "Indexers/ILoveTorrents.json",
                "Indexers/ILoveTorrents.json.bak",
                ...
                "Indexers/nostream.json",
                "Indexers/nostream.json.bak",
                "Indexers/NxtGn.json",
                "Indexers/NxtGn.json.bak",
                "Indexers/nyaa.json",
                ...
                "Indexers/PhxBit.json",
                "Indexers/PhxBit.json.bak",
                ...
                "Indexers/SceneAccess.json",
                "Indexers/SceneAccess.json.bak",
                ...
                "Indexers/SevenTor.json",
                "Indexers/SevenTor.json.bak",
                ...
                "Indexers/Strike.json",
                "Indexers/Strike.json.bak",
                "Indexers/Synthesiz3r.json",
                "Indexers/Synthesiz3r.json.bak",
                "Indexers/t411.json",
                ...
                "Indexers/TorrentShack.json",
                "Indexers/TorrentShack.json.bak",
                ...
                "Indexers/Torrentz.json",
                "Indexers/Torrentz.json.bak",
