...
public class DashboardTests
{
    ...
    public void AddIndexerOpens()
    {
        ...
        DashboardTests.WaitUntilModalIsDisplayed("#select-indexer-modal h4");
    ...
    public void CheckIndexersAreAvailableToAdd()
    {
        ...
        Assert.IsGreaterThan(400, indexerCount);
    }
    ...
    public void ManualSearchOpens()
    {
        ...
        DashboardTests.WaitUntilModalIsDisplayed("#select-indexer-modal div.modal-body p");
    ...
    {
        const string url = "http://localhost:9117/UI/Dashboard";
    ...
    private static bool WaitUntilModalIsDisplayed(string cssSelector)
    {
