...
document.addEventListener('DOMContentLoaded', () => {
    ...
    $.fn.stableFocus = function() {
        utils.stableFocus(this[0]);
    };
...
function bindButtons() {
    ...
    document.body.addEventListener('click', async (e) => {
        if (!(e.target.classList.contains('jacketdownloadserver') || e.target.closest('.jacketdownloadserver'))) {
            return;
        }
        e.preventDefault();
        const btn = e.target.closest('.jacketdownloadserver');
                ...
                initComplete() {
                    ...
                    this.api().columns().every(function() {
                        ...
                        select.addEventListener('change', () => {
                            const val = utils.escape(select.value);
