    ...
    internal class ConfigurationDataXthor : ConfigurationData
    {
        ...
        public ConfigurationDataXthor()
        {
            CredentialsWarning = new DisplayItem(
                "<b>Credentials Configuration</b> (<i>Private Tracker</i>),<br /><br /> <ul><li><b>PassKey</b> is your private key on your account</li></ul>")
            {
                Name = "Credentials"
            };
