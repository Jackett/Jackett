...
namespace Jackett.Common.Utils
{
    public static class StringUtil
    {
        ...
        public static string PostDataFromDict(IEnumerable<KeyValuePair<string, string>> dict) =>
            new FormUrlEncodedContent(dict).ReadAsStringAsync().Result;
        ...
        public static string GetExceptionDetails(this Exception exception)
        {
            ...
            var fields = properties.Select(property => new { property.Name, Value = property.GetValue(exception, null) })
                                   .Select(
                                       x => string.Format(
        ...
        private static char[] s_MakeValidFileNameInvalids;
        ...
        public static string MakeValidFileName(string text, char? replacement = '_', bool fancy = true)
        {
            ...
            var invalids = s_MakeValidFileNameInvalids ?? (s_MakeValidFileNameInvalids = Path.GetInvalidFileNameChars());
            var changed = false;
        ...
        public static string GetQueryString(this NameValueCollection collection, Encoding encoding = null)
        {
            ...
            return string.Join(
                "&", collection.AllKeys.Select(a => $"{a}={WebUtilityHelpers.UrlEncode(collection[a], encoding)}"));
        }

        public static string GetQueryString(this ICollection<KeyValuePair<string, string>> collection,
