    ...
    public static class LoggingSetup
    {
        public static LoggingConfiguration GetLoggingConfiguration(RuntimeSettings settings, bool fileOnly = false)
        {
            ...
            ConfigurationItemFactory.Default.LayoutRenderers.RegisterDefinition(
                "simpledatetime", typeof(SimpleDateTimeRenderer));
            ...
            var microsoftRule = new LoggingRule { LoggerNamePattern = "Microsoft.*" };
            microsoftRule.SetLoggingLevels(LogLevel.Warn, LogLevel.Fatal);
            microsoftRule.Final = true;
            microsoftRule.Targets.Add(logFile);
            var microsoftDebugRule = new LoggingRule { LoggerNamePattern = "Microsoft.*" };
