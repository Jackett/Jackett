...
namespace Jackett.Common.Utils.Clients
{
    ...
    public class HttpWebClient2NetCore : WebClient
    {
        ...
        public HttpWebClient2NetCore(IProcessService p, Logger l, IConfigurationService c, ServerConfig sc) : base(
            p, l, c, sc)
        {
            if (webProxyUrl == null)
                InitProxy(sc);
        ...
        public void CreateClient()
        {
            ...
            _clientHandlr.ServerCertificateCustomValidationCallback = ValidateCertificate;
