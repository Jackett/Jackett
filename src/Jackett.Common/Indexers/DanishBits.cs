...
namespace Jackett.Common.Indexers
{
    public class DanishBits : CouchPotatoTracker
    {
        ...
        public DanishBits(IIndexerConfigurationService configService, WebClient c, Logger l, IProtectionService ps) : base(
            name: "DanishBits", description: "A danish closed torrent tracker", link: "https://danishbits.org/",
            endpoint: "couchpotato.php", configService: configService, client: c, logger: l, p: ps,
            configData: new ConfigurationDataUserPasskey(
                "Note about Passkey: This is not your login Password. Find the Passkey by logging into DanishBits with your Browser, and under your account page you'll see your passkey under the 'Personal' section on the left side."))
        {
        ...
        protected override async Task<WebClientByteResult> RequestBytesWithCookiesAsync(
            ...
            IEnumerable<KeyValuePair<string, string>> data = null, Dictionary<string, string> headers = null)
        {
            ...
            return await base.RequestBytesWithCookiesAsync(url, cookieOverride, method, referer, data, headers);
        }
    }
}
