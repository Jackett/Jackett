...
namespace Jackett.Common.Indexers.Meta
{
    public class AggregateIndexer : BaseMetaIndexer
    {
        ...
        public AggregateIndexer(IFallbackStrategyProvider fallbackStrategyProvider,
                                ...
                                WebClient wc, Logger l, IProtectionService ps) : base(
            "AggregateSearch", "This feed includes all configured trackers", fallbackStrategyProvider, resultFilterProvider,
            configService, wc, l, new ConfigurationData(), ps, x => true)
        {
        }
