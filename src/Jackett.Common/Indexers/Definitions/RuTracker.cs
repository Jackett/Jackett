...
namespace Jackett.Common.Indexers.Definitions
{
    ...
    public class RuTracker : IndexerBase
    {
        ...
        private TorznabCapabilities SetCapabilities()
        {
            ...
            caps.Categories.AddCategoryMapping(1163, TorznabCatType.Audio, "|- Многоканальная музыка в формате Dolby Atmos");
            caps.Categories.AddCategoryMapping(1164, TorznabCatType.Audio, "|- Классическая вокальная и хоровая музыка, Classical Crossover (Hi-R..");
            caps.Categories.AddCategoryMapping(1884, TorznabCatType.Audio, "|- Классическая инструментальная музыка, Classical Crossover (Hi-Res)");
            caps.Categories.AddCategoryMapping(1885, TorznabCatType.Audio, "|- Поп-музыка (Hi-Res)");
            ...
            caps.Categories.AddCategoryMapping(1755, TorznabCatType.Audio, "|- Rock (Hi-Res)");
            caps.Categories.AddCategoryMapping(1757, TorznabCatType.Audio, "|- Prog Rock & Art Rock (Hi-Res)");
            caps.Categories.AddCategoryMapping(1890, TorznabCatType.Audio, "|- Metal (Hi-Res)");
            caps.Categories.AddCategoryMapping(1396, TorznabCatType.Audio, "|- Alternative, Punk, Independent (Hi-Res)");
            caps.Categories.AddCategoryMapping(2302, TorznabCatType.Audio, "|- Jazz, Bop, Cool, Fusion, Avant-Garde Jazz (Hi-Res)");
            caps.Categories.AddCategoryMapping(2303, TorznabCatType.Audio, "|- Vocal Jazz, Funk, Soul, R&amp;B, Jazz-Pop (Hi-Res)");
            caps.Categories.AddCategoryMapping(2345, TorznabCatType.Audio, "|- Blues (Hi-Res)");
            caps.Categories.AddCategoryMapping(1893, TorznabCatType.Audio, "|- Электронная музыка (Hi-Res)");
            caps.Categories.AddCategoryMapping(1397, TorznabCatType.Audio, "|- Саундтреки (Hi-Res)");
            caps.Categories.AddCategoryMapping(2512, TorznabCatType.Audio, "|- Музыка других жанров (Hi-Res)");
