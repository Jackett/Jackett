...
namespace Jackett.Common.Indexers
{
    public class TorrentHeaven : BaseWebIndexer
    {
        ...
        public TorrentHeaven(IIndexerConfigurationService configService, WebClient wc, Logger l, IProtectionService ps) :
            base(
                "TorrentHeaven", description: "A German general tracker.", link: "https://newheaven.nl/",
                ...
                configData: new ConfigurationDataCaptchaLogin())
        {
            ...
            Language = "de-de";
            Type = "private";
            wc.AddTrustedCertificate(
                new Uri(SiteLink).Host, "cbf23ac75b07255ad7548a87567a839d23f31576"); // incomplete CA chain
        ...
        {
            var loginPage = await RequestStringWithCookiesAsync(IndexUrl, string.Empty);
        ...
        public override async Task<IndexerConfigurationStatus> ApplyConfiguration(JToken configJson)
        {
            ...
            var result = await RequestLoginAndFollowRedirectAsync(
                IndexUrl, pairs, configData.CaptchaCookie.Value, true, null, IndexUrl, true);
            ...
            var result2 = await RequestStringWithCookiesAsync(LoginCompleteUrl, result.Cookies);
        ...
        protected override async Task<IEnumerable<ReleaseInfo>> PerformQuery(TorznabQuery query)
        {
            ...
            try
            {
                ...
                {
                    var release = new ReleaseInfo { MinimumRatio = 0.8, MinimumSeedTime = 0 };
                    var qRow = row.Cq();
                    ...
                    var dateGerman = dateStrParts[0] == "Heute"
                        ? DateTime.SpecifyKind(DateTime.UtcNow.Date, DateTimeKind.Unspecified) +
                                     TimeSpan.Parse(dateStrParts[1])
                        : dateStrParts[0] == "Gestern"
                        ? DateTime.SpecifyKind(DateTime.UtcNow.Date, DateTimeKind.Unspecified) +
                                     TimeSpan.Parse(dateStrParts[1]) - TimeSpan.FromDays(1)
                    ...
                    release.DownloadVolumeFactor = qRow.Find("img[src=\"themes/images/freeleech.png\"]").Length >= 1
                        ? 0
                        : qRow.Find("img[src=\"themes/images/DL50.png\"]").Length >= 1 ? 0.5 : 1;
