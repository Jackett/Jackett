...
namespace Jackett.Common.Indexers
{
    ...
    public class GimmePeers : BaseWebIndexer
    {
        ...
        public GimmePeers(IIndexerConfigurationService configService, WebClient wc, Logger l, IProtectionService ps) : base(
            "GimmePeers", description: "Formerly ILT", link: "https://www.gimmepeers.com/", caps: new TorznabCapabilities(),
