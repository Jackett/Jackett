...
namespace Jackett.Common.Indexers
{
    ...
    public class Xthor : BaseCachingWebIndexer
    {
                  ...
                  )
        {
            ...
            var ConfigDropCategories = new SingleSelectConfigurationItem("Drop categories requested ?", new Dictionary<string, string>
            {
                {"0", "Disabled"},
            ...
            if (categoriesList.Count > 0)
            {
                switch (DropCategories)
                {
                    case 1:
                        ...
                        if(!query.IsTmdbQuery) { goto default; }
                        break;
                    case 2:
