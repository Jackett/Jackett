...
{
    public class MyAnonymouse : BaseIndexer, IIndexer
    {
        private string LoginUrl { get { return SiteLink + "login.php"; } }
        private string SearchUrl { get { return SiteLink + "tor/browse.php?tor%5Btext%5D="; } }
        ...
        public MyAnonymouse(IIndexerManagerService i, IWebClient c, Logger l, IProtectionService ps)
            : base(name: "MyAnonymouse",
